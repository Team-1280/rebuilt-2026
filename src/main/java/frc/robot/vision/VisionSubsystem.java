...
public class VisionSubsystem extends SubsystemBase {
    ...
    private final Camera[] cameras = {
        new Camera("Intake", VisionConst.TRIPLE_INTAKE_CAMERA_TRANSFORM),
        new Camera("Back", VisionConst.TRIPLE_RIGHT_CAMERA_TRANSFORM),
        new Camera("Right", VisionConst.TRIPLE_BACK_CAMERA_TRANSFORM),
    };
