...
public class CommandSwerveDrivetrain
                ...
                private final SysIdRoutine m_sysIdRoutineTranslation = new SysIdRoutine(
                                                ...
                                                new SysIdRoutine.Mechanism(
                                                                                output -> setControl(m_translationCharacterization
                                                                                                                .withVolts(output)),
                                                                                null,
                                                                                this));
                ...
                private final SysIdRoutine m_sysIdRoutineSteer = new SysIdRoutine(
                                                new SysIdRoutine.Config(
                                                                                ...
                                                                                state -> SignalLogger.writeString(
                                                                                                                ...
                                                                                                                state.toString())),
                                                new SysIdRoutine.Mechanism(
                                                                                volts -> setControl(m_steerCharacterization
                                                                                                                .withVolts(volts)),
                                                                                null,
                                                                                this));
                 ...
                 *                                  calculation in the
                 *                                  transpose of [x, y, theta], with units in
                 *                                  meters and radians
                 * @param visionStandardDeviation   The standard deviation for vision
                 *                                  calculation in the transpose
                 *                                  of [x, y, theta], with units in meters and
                 *                                  radians
                 * @param modules                   Constants for each specific module
                 */
                public CommandSwerveDrivetrain(
                ...
                public void configureAutoBuilder() {
                                try {
                                                ...
                                                AutoBuilder.configure(
                                                                                ...
                                                                                // pose
                                                                                // supplier
                                                                                this::resetPose, // Method
                                                                                // to
                                                                                // reset
                                                                                // odometry
                                                                                () -> getState().Speeds, // ChassisSpeeds
                                                                                // supplier.
                                                                                // MUST
                                                                                // BE
                                                                                // ROBOT
                ...
                public void periodic() {
                                 ...
                                 * If we haven't applied the operator perspective
                                 * before, then we should apply
                                 * it regardless of DS state.
                                 * This allows us to correct the perspective in case the
                                 * robot code restarts
                                 * mid-match.
                                 * Otherwise, only check and apply the operator
                                 * perspective if the DS is
                                 * disabled.
                                 * This ensures driving behavior doesn't change until an
                                 * explicit disable event
                ...
                public Command getAlignToFieldPosition(
                                ...
                                return run(() -> {
                                                ...
                                                double vel_mag = fieldPositionController.calculate(
                                                ...
                                                setControl(
                                                                                alignDriveRequest
                                                                                                                ...
                                                                                                                .withTargetDirection(targetPoseSupplier
                                                                                                                                                .get()
                                                                                                                                                .getRotation()));
                                })
                ...
                private void startSimThread() {
                                ...
                                /*
                                 * Run simulation at a faster rate so PID gains behave
                                 * more reasonably
                                 */
