...
public class DrivetrainOdometry extends CommandSwerveDrivetrain {
    ...
    public void addVisionWithPoseScaling(Pose2d visionPose, double timestampSeconds, double distanceToTag,
            double Ambiguity) {
    ...
    public void updateOdometryTrust() {
        ...
        // note: CTRE's CommandSwerveDrivetrain may not expose odometry stdDev
        // adjustment aparently
        // this would need to be handled differently depending on your base class
    }
    // under this i think it needs to store values for next comparison and
    // updatecache but idk how to do
